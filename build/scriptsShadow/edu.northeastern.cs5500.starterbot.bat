...
set CLASSPATH=%APP_HOME%\lib\edu.northeastern.cs5500.starterbot-all.jar

@rem Execute edu.northeastern.cs5500.starterbot
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EDU_NORTHEASTERN_CS5500_STARTERBOT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
